-- Reset database with stable test data
-- This migration ensures consistent, deterministic test data for development
-- Run this when you need to reset your local database to a known state
...
-- Delete by user_id IS NULL and outcome pattern (works even if token column doesn't exist)
-- This is safer for remote databases that might have different schemas
DELETE FROM orders WHERE user_id IS NULL AND outcome LIKE 'outcome-team-champion-%';

-- Delete all trades (optional - uncomment if you want to reset trades too)
-- DELETE FROM trades;

-- Delete all positions (optional - uncomment if you want to reset positions too)
-- DELETE FROM positions;

-- Insert stable mock orderbook data
-- All prices are whole dollars (multiples of 100 cents)
-- Gap between best bid and best ask is always 2 dollars (200 cents)

-- Loop & Boose - Best bid $18, best ask $20 (2 dollar gap)
...
-- Krass & TK - Best bid $16, best ask $18 (2 dollar gap)
INSERT INTO orders (create_time, user_id, token, order_id, outcome, price, status, tif, side, contract_size) VALUES
...
-- CTH & Avayou - Best bid $15, best ask $17 (2 dollar gap)
INSERT INTO orders (create_time, user_id, token, order_id, outcome, price, status, tif, side, contract_size) VALUES
...
-- Alex & Huffman - Best bid $15, best ask $17 (2 dollar gap)
INSERT INTO orders (create_time, user_id, token, order_id, outcome, price, status, tif, side, contract_size) VALUES
...
-- Jon & Tim - Best bid $13, best ask $15 (2 dollar gap)
INSERT INTO orders (create_time, user_id, token, order_id, outcome, price, status, tif, side, contract_size) VALUES
...
-- Doc & Will - Best bid $11, best ask $13 (2 dollar gap)
INSERT INTO orders (create_time, user_id, token, order_id, outcome, price, status, tif, side, contract_size) VALUES
