...
export const api = {
  ...
  adminGetLeaderboard: () =>
    apiRequest<{
      ...
      stats_by_market_type?: Record<string, Record<string, { trade_count: number; open_orders_count: number; shares_traded: number; portfolio_value_cents: number; closed_profit_cents: number; settled_profit_cents: number }>>;
