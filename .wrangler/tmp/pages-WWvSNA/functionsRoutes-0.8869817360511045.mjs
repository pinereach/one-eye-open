...
import { onRequestGet as __api_markets__marketId__reference_ts_onRequestGet } from "/Users/dhuffman/Documents/GitHub/one-eye-open1/functions/api/markets/[marketId]/reference.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_markets__marketId__reference_ts_onRequestGet],
    },
  {
