...
// ../.wrangler/tmp/bundle-va1Ueq/checked-fetch.js
...
// api/admin/orders/cancel-all.ts
...
// api/admin/closed-profit-from-risk-off.ts
...
// api/admin/leaderboard/index.ts
var onRequestGet3 = /* @__PURE__ */ __name(async (context) => {
  ...
  const db = getDb(env);
  try {
    let getOrCreate2 = function(userId, marketType) {
      ...
      return s;
    }, unrealizedPnlRaw2 = function(p, currentPrice) {
    ...
    __name(getOrCreate2, "getOrCreate");
    __name(unrealizedPnlRaw2, "unrealizedPnlRaw");
...
// api/admin/rebalance-closed-profit.ts
...
__name(slugForOutcomeId2, "slugForOutcomeId");
...
__name(computedSettledProfitCents2, "computedSettledProfitCents");
...
__name(computedSettledProfitCents3, "computedSettledProfitCents");
var onRequestGet16 = /* @__PURE__ */ __name(async (context) => {
  ...
  const normalizeMarketId = /* @__PURE__ */ __name((p) => p.market_id === "market_total_birdies" ? "market-total-birdies" : p.market_id, "normalizeMarketId");
...
// ../.wrangler/tmp/pages-vZxsLz/functionsRoutes-0.9475790600496836.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-va1Ueq/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-va1Ueq/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2986485560156067.mjs.map
